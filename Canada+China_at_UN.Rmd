...
```{r}
# Ajout d'un tableau synthétisant les résolutions
...
Le tableau contient `r onu_large %>% pull(resid) %>% unique() %>% length()` résolutions distinctes depuis 1946, réparties en `r dim(onu_large)[1]` enregistrements. Nous en présentons un échantillon du tableau en annexe. 
